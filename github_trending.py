...
def get_open_issues_amount(repo_owner, repo_name):
    ...
    return [x['url'] for repo_issue in repo_issues_list if 'pull_request' not in repo_issue]
...
if __name__ == '__main__':
    ...
    for x in repos_list:
        repo_owner, repo_name, stars_amount = x['owner']['login'], x['name'], x['stargazers_count']
